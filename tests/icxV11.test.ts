...
describe('ICX generation targets spec v1.1', () => {
  const source = parser.parse(fixture('sample.icf'))

  it('generates ICX declaring @version 1.1 with a clean write → parse round trip', () => {
    ...
    expect(reparsed.getMetadata().getVersion()).toBe('1.1')
